...
public class ShopSecond extends Activity implements RewardedVideoAdListener {
    ...
    public ArrayList getListData() {
        ...
        holdingsData.setName("Obejrzyj reklamę");
        holdingsData.setDescription("Zwiększa dochód o 100%");
